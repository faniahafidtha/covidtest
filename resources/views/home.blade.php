...
<div class="col-md-8">
    <div class="card shadow-sm border-0">
        <div class="card-header">Survey COVID-19</div>
        ...
        <div class="card-body">
            ...
            <form action="{{ route('survey.store') }}" method="POST">
               ...
               <table class="table table-bordered table-hover" id="datatables">
                    ...
                    <tbody>
                        <tr>
                            <td colspan="4"><strong>A.POTENSI TERTULAR DILUAR RUMAH</strong></td>
                        </tr>
                       <tr>
                    ...
                    <tr>
                            <td colspan="4"><strong>B.POTENSI TERTULAR DIDALAM RUMAH</strong></td>
                        </tr>
                    <tr>
                    ...
                    <tr>
                            <td colspan="4"><strong>C.DAYA TAHAN TUBUH(IMUNITAS)</strong></td>
                        </tr>
                    <tr>
